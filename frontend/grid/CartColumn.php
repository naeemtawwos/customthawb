...
class CartColumn extends Column
{
     ...
     * {@inheritdoc}
     */
    public $headerOptions = ['class' => 'shopping-cart-column'];
    /**
    ...
    {
        $this->initDefaultButton('buy', 'shopping-cart', [
            'data-confirm' => Yii::t('yii', 'Are you sure you wanna buy this?'),
            'data-method' => 'post',
        ]);
        /*his->initDefaultButton('update', 'pencil');
